...
function criaCampoNome() {
  $(".formulario").append("<div class='mb-3 row'><label for='nome' class='col-sm-2 col-form-label'>Nome</label><div class='col-sm-10'><input type='text' class='form-control' pattern='[a-zA-Z]*' id='nome' required onblur='verificaNome(this.value)' placeholder='Nome Completo [max 50]' maxlength='50'></div></div>")
  
}
function criaCampoCPF() {
  $(".formulario").append("<div class='mb-3 row'><label for='cpf' class='col-sm-2 col-form-label'>CPF</label><div class='col-sm-10'><input type='text' class='form-control' pattern='[0-9]{3}\.?[0-9]{3}\.?[0-9]{3}\-?[0-9]{2}' id='cpf' required onke placeholder='CPF' onkeyup='verificaCPF()'></div></div>")
}
function criaCampoApelido() {
  $(".formulario").append("<div class='mb-3 row'><label for='apelido' class='col-sm-2 col-form-label'>Apelido</label><div class='col-sm-10'><input type='text' class='form-control' pattern='[a-zA-Z]*' id='apelido' required onblur='verificaApelido(this.value)' placeholder='Apelido [max 20]' maxlength='20'></div></div>")
}
function criaCampoEmail() {
  $(".formulario").append("<div class='mb-3 row'><label for='email' class='col-sm-2 col-form-label'>Email</label><div class='col-sm-10'><input type='email' class='form-control col-sm-5' id='email' required onblur='verificaEmail(this.value)' placeholder='Email' maxlength='50'></div></div>")
}
function criaCampoData() {
  $(".formulario").append("<div class='mb-3 row'><label for='data' class='col-sm-2 col-form-label'>Data de Nascimento</label><div class='col-sm-10'><input type='date' class='form-control' id='data' required onke placeholder='dd/mm/yyyy' onkeyup='verificaData()'></div></div>")
}
function criaCampoCEP() {
  $(".formulario").append("<div class='mb-3 row'><label for='cep' class='col-sm-2 col-form-label'>CEP</label><div class='col-sm-10'><input type='text' class='form-control' pattern='[0-9]{5}\-[0-9]{3}' id='cep' required placeholder='CEP' onkeyup='verificaCEP()'></div></div>")
}
...
function criaCampoWhats() {
  $(".formulario").append("<div class='mb-3 row'><label for='whats' class='col-sm-2 col-form-label'>Whatsapp</label><div class='col-sm-10'><input type='text' class='form-control' minlength='15' id='whats' required placeholder='(DDD) Telefone' onkeyup='verificaWhats()'></div></div>")
}
